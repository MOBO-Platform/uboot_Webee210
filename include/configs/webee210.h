...
#define CONFIG_SERIAL0			3	/* use SERIAL 3 */
#define  DEBUG
...
#define CONFIG_SYS_PROMPT              "[mobo_210]# "
#define CONFIG_SYS_CBSIZE               256     /* Console I/O Buffer Size*/
#define CONFIG_SYS_PBSIZE               384     /* Print Buffer Size */
#define CONFIG_SYS_MAXARGS              16      /* max number of command args */

#define CONFIG_BOOTCOMMAND "tftp 0x30007fc0 uImage_s5pv210;bootm 0x30007fc0"
#define CONFIG_BOOTARGS "root=/dev/nfs rw nfsroot=192.168.1.109:/usr/nfs_root,proto=tcp,nfsvers=3,nolock \
	                     ip=192.168.1.1:192.168.1.109:192.168.1.254:255.255.255.0:YWW:eth0:off console=ttySAC0,115200 init=/linuxrc"
...
#define CONFIG_SERVERIP 	192.168.1.109
